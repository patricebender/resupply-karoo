package io.resupply.karoo.ui.field
 ...
 * DataType builds these off [io.resupply.karoo.data.upcomingByCategory].
 */
 ...
 * field is a shortcut into Resupply regardless of what it's currently showing.
 */
@androidx.glance.appwidget.ExperimentalGlanceRemoteViewsApi
@androidx.compose.runtime.Composable
...
const val EXTRA_ACTION = "resupply.field.action"
const val ACTION_BUILD = "build"

/** Intent that just opens the Resupply app (no build), used for tap-to-open. */
 ...
 * tapping to select/move/DELETE the field launches Resupply instead, so the field can't be
...
/**
 * "Build" prompt (no roadbook yet). Tapping opens the Resupply app straight into a
